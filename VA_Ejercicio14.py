#Filtro no lineal: Bilateral
#Funcion utilizada: cv.bilateralFilter()
...
img_blur1 = cv.bilateralFilter(img,9,75,75)
img_blur2 = cv.bilateralFilter(img,21,100,100)

fig, ax= plt.subplots(1,3)
fig.suptitle('Filtro bilateral')
